...
export default class ImagePainter extends LightningElement {
  ...
  createNewCanvasObjects() {
    ...
    this.overlayCanvas.addEventListener('mouseout', this.handleMouseOut.bind(this));
  ...
  handleMouseMove(event){
    ...
    setupCoordinate(eventParam){
        const clientRect = this.overlayCanvas.getBoundingClientRect();
        prevX = currX;
        prevY = currY;
    ...
    redraw() {
        ...
        this.overlayContext.moveTo(prevX, prevY);
        this.overlayContext.lineTo(currX, currY);
        this.overlayContext.strokeStyle = this.selectedColor.description;
        this.overlayContext.lineWidth = this.selectedThickness;        
    ...
    drawDot(){
        this.overlayContext.beginPath();
        this.overlayContext.fillStyle = this.selectedColor.description;
        this.overlayContext.fillRect(currX, currY, this.selectedThickness, this.selectedThickness); 
        this.overlayContext.closePath();
    }
}